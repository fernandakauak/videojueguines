export const juegos = [
  ...
  },
  {
    ...
    genero: ['Novela Visual', 'Simulación'],
    anio: '2022',
    plataforma: ['PC', 'Nintendo Switch'],
    clasificacion: 'M',
    desarrollador: 'WSS Playground',
  ...
  },
  {
    ...
    genero: ['RPG', 'Aventura'],
    anio: '1994',
    plataforma: ['SNES', 'GBA', 'Wii U', 'Nintendo Switch'],
    clasificacion: 'T',
    desarrollador: 'APE Inc. / HAL Laboratory',
  ...
  },
  {
    ...
    clasificacion: 'M',
    desarrollador: 'Edmund McMillen & Florian Himsl',
  ...
  },
  {
    id: 6,
    nombre: 'Sally Face',
    genero: ['Aventura Gráfica', 'Misterio', 'Terror'],
    anio: '2016',
    plataforma: ['PC', 'Nintendo Switch', 'PS4', 'Xbox One'],
    clasificacion: 'M',
    desarrollador: 'Portable Moose',
  ...
  },
  {
    ...
    genero: ['JRPG'],
    anio: '1995',
    plataforma: ['SNES', 'PlayStation', 'Nintendo DS', 'PC'],
    clasificacion: 'E',
  ...
  },
  {
    id: 11,
    nombre: 'Balatro',
    genero: ['Roguelike', 'Construcción de Mazos'],
    anio: '2024',
    plataforma: ['PC', 'Nintendo Switch', 'PS4', 'PS5', 'Xbox', 'iOS', 'Android'],
    clasificacion: 'E10+',
